...
public class BubbleSortMusicGenerator {
	
	private BubbleSortDataGenerativeInfo data;
	
	public BubbleSortMusicGenerator(BubbleSortDataGenerativeInfo data) {
		this.data = data;
	}
	...
	public int[] getNotes() {
		...
		int root = data.getModeEle() % 	nops.getNumNoteValues();
